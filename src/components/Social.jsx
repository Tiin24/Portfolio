    ...
    <div class="hidden lg:block">
      <ul className="flex space-x-6 ">
        <li className="flex justify-center items-center text-accent">
          <a className="text-base" href="https://github.com/Tiin24" target="_blank" rel="noreferrer">
        ...
        <li className="flex justify-center items-center text-accent">
          <a className="text-base" href="https://www.linkedin.com/in/isaias-romero/" target="_blank" rel="noreferrer">
